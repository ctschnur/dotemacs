...
~helm-projectile-ag~ is a great function for refactoring code, but ag comes only native to Linux and not Windows. 
...
#+RESULTS:
sadly, it doesn't exist on Windows.
...
#+BEGIN_SRC emacs-lisp
  (use-package pyvenv
    ...
    (with-system windows-nt
      (setenv "WORKON_HOME" (expand-file-name "C:/Users/nanospin/AppData/Local/Continuum/anaconda3/envs"))
    )
